...
export default function AboutPage() {
  return (
    <main className="font-sans bg-[#F9FAFB] min-h-screen pb-20">
      ...
      {/* ================= ABOUT US SECTION ================= */}
      <section className="relative py-16 px-4 sm:px-6 lg:px-12 bg-gradient-to-br from-[#FFF5F5] via-[#FFEBEB] to-[#FFFFFF] text-gray-800 overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          
          {/* Left Column: Image Collage Section */}
          <div className="lg:col-span-6 relative w-full h-[450px] sm:h-[550px] lg:h-[600px] flex items-center justify-center">
            
            {/* Main Top Right Image */}
            <div className="absolute top-0 right-0 w-[70%] h-[70%] rounded-[2.5rem] overflow-hidden shadow-xl border-4 border-white transition-transform duration-500 hover:scale-[1.02]">
              <img 
            ...
            <div className="absolute bottom-4 left-0 w-[62%] h-[62%] rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white z-10 transition-transform duration-500 hover:scale-[1.02]">
              <img 
            ...
            <div className="absolute top-4 left-4 w-[35%] h-[30%] rounded-[1.8rem] overflow-hidden shadow-lg border-2 border-white z-0 hidden sm:block">
              <img 
            ...
            <div className="absolute bottom-10 right-4 sm:right-8 w-32 h-32 sm:w-36 sm:h-36 bg-red-600 rounded-full flex items-center justify-center shadow-2xl border-4 border-white z-20">
              <svg className="w-full h-full animate-[spin_12s_linear_infinite]" viewBox="0 0 100 100">
                <path
                  ...
                  fill="none"
                />
                <text className="text-[9.5px] font-bold tracking-widest uppercase fill-white">
                  <textPath href="#circlePath" startOffset="0%">
                    ACE CERTIFICATIONS • COMPLIANCE & EXCELLENCE •
                  </textPath>
                </text>
              </svg>
              <div className="absolute inset-0 m-auto w-14 h-14 bg-red-700 rounded-full flex items-center justify-center text-white shadow-inner">
      ...
      {/* ================= MISSION & VISION SECTION (NEW LAYOUT FROM IMAGE) ================= */}
      <section className="py-20 px-4 sm:px-6 lg:px-12 bg-white text-gray-800">
        <div className="max-w-6xl mx-auto">
          
          {/* Top Pill & Main Heading (Image Style) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            {/* Our Mission Card */}
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-gray-200/80 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-start">
              <div className="w-12 h-12 rounded-xl bg-red-600 text-white flex items-center justify-center mb-6 shadow-md shadow-red-200">
              ...
              </p><p className='text-gray-600 text-justify '>  We achieve this by: Providing Rigorous & Impartial Certification: Delivering reliable, value-added audit services that uphold the highest standards of integrity and accreditation.
      ...
      {/* ================= CORE VALUES SECTION ================= */}
      <section className="py-16 px-4 sm:px-6 lg:px-12 bg-gray-50/50">
      ...
      {/* ================= OUR PURPOSE SECTION (UNCHANGED DESIGN) ================= */}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-16 lg:gap-12 items-center">
            ...
            <div className="lg:w-1/2 space-y-8">
              ...
              <div className="space-y-5 text-lg text-gray-600 leading-relaxed text-justify">
                <p>
            ...
            <div className="lg:w-1/2 w-full space-y-5">
              ...
              {/* Card 1: Trust */}
              <div className="group bg-white p-6 md:p-8 rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(220,38,38,0.12)] hover:border-red-200 transition-all duration-300 flex flex-col sm:flex-row gap-6 items-start transform hover:-translate-y-1">
                <div className="w-16 h-16 rounded-2xl bg-red-50 text-red-600 flex items-center justify-center shrink-0 group-hover:bg-red-600 group-hover:text-white transition-colors duration-300">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                </div>
                <div>
                  <h4 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-red-600 transition-colors">Build Unshakeable Trust</h4>
                  <p className="text-gray-600 leading-relaxed text-justify">Prove your commitment to safety, quality, and excellence to your clients and stakeholders.</p>
                </div>
              </div>
              ...
              <div className="group bg-white p-6 md:p-8 rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(220,38,38,0.12)] hover:border-red-200 transition-all duration-300 flex flex-col sm:flex-row gap-6 items-start transform hover:-translate-y-1">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-red-600 transition-colors">Unlock Market Potential</h4>
                  <p className="text-gray-600 leading-relaxed text-justify">Open doors to new contracts, global opportunities, and regulatory compliance with confidence.</p>
                </div>
              </div>
              ...
              <div className="group bg-white p-6 md:p-8 rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(220,38,38,0.12)] hover:border-red-200 transition-all duration-300 flex flex-col sm:flex-row gap-6 items-start transform hover:-translate-y-1">
                ...
                <div>
                  <h4 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-red-600 transition-colors">Drive Operational Excellence</h4>
                  <p className="text-gray-600 leading-relaxed text-justify">Transform rigorous industry standards into streamlined, efficient, and highly profitable everyday practices.</p>
                </div>
              </div>
          ...
          {/* Bottom Banner */}
          <div className="mt-16 bg-gray-900 rounded-[2rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden shadow-2xl border border-gray-800 transform hover:scale-[1.01] transition-transform duration-500">
            ...
            <div className="relative z-10 flex items-start gap-4">
              <span className="text-5xl text-red-500 font-serif leading-none opacity-50">"</span>
              <p className="text-xl md:text-2xl lg:text-3xl font-semibold text-white max-w-4xl leading-snug">
